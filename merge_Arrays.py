# Description: https://www.codewars.com/kata/58b665c891e710a3ec00003f/python
# Short task summary:
##Task
##
...
def merge_arrays(a, b):
    return sorted([x for x in set(a + b) if a.count(x) == b.count(x) or (a.count(x) > 0 and b.count(x) == 0) or (a.count(x) == 0 and b.count(x) > 0)])
