# Description: https://www.codewars.com/kata/5a5c118380eba8a53d0000ce/python
# Short task summary:
...
def convert_my_dollars(usd, currency):
    return "You now have {} of {}.".format(str(usd * (CONVERSION_RATES[currency])), currency) if currency[0].lower() in 'aeoui' else "You now have {} of {}.".format((usd * int(str(CONVERSION_RATES[currency]),2)), currency)
